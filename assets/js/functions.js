...
include('assets/js/vendor/TweenLite.min.js');
include('assets/js/vendor/TimelineLite.min.js');
include('assets/js/vendor/CSSPlugin.min.js');
include('assets/js/vendor/CSSRulePlugin.min.js');
include('assets/js/vendor/ScrollToPlugin.min.js');
include('assets/js/vendor/jquery.gsap.min.js');
include('assets/js/vendor/jquery.ScrollMagic.min.js');
include('assets/js/vendor/ScrollMagic.min.js');
include('assets/js/vendor/animation.gsap.min.js');
